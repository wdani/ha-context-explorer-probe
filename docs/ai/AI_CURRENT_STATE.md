...
- Minimal HACS custom repository starter metadata, provisional README logo and icon assets, local integration brand assets, external Home Assistant Brands helper assets, release checklist, HACS custom repository test checklist, and clearer manual/HACS/update documentation
